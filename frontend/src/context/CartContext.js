...
export const CartProvider = ({ children }) => {
  ...
  // ===================================================================
  // ★★★ SỬA LỖI CHÍNH — ADD TO CART DÀNH CHO GUEST (QUAN TRỌNG NHẤT) ★★★
  // ===================================================================
  /**
   * product ở đây chính là guestItemPayload gửi từ ProductDetail:
   * {
   *   _id: 'productId-variantId',
   *   product: { _id, name, images, price },
   *   price, variantId, variantName, quantity
   * }
   */
